#!/bin/bash
# Complete fix including creating directories and docker-compose

set -e

echo "=== Creating application directory ==="
sudo mkdir -p /opt/academyfirstaid/flashcards-app/data
sudo mkdir -p /opt/academyfirstaid/questions
...
echo "=== Testing ==="
docker ps | grep academyfirstaid || echo "⚠️  Container not running"
curl -s -o /dev/null -w "App Status: %{http_code}\n" http://127.0.0.1:3000/api/decks || echo "⚠️  App not responding on port 3000"
